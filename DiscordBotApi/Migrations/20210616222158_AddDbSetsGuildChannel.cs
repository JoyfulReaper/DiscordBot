...
{
    public partial class AddDbSetsGuildChannel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServerLogItem", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServerLogItem_Channel_ChannelId",
                        column: x => x.ChannelId,
                        principalTable: "Channel",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServerLogItem_Guild_GuildId",
                        column: x => x.GuildId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServerLogItem_ChannelId",
                table: "ServerLogItem",
                column: "ChannelId");

            migrationBuilder.CreateIndex(
                name: "IX_ServerLogItem_GuildId",
                table: "ServerLogItem",
                column: "GuildId");
        }
